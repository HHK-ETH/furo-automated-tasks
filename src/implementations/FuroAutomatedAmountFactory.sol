...
contract FuroAutomatedAmountFactory is BaseFuroAutomatedFactory {
        ...
        returns (BaseFuroAutomated furoAutomated, bytes memory initData)
    {
        (
            ...
            bytes memory taskData
                ...
                data,
                (uint256, address, address, uint256, bool, bool, bytes)
            );
        ...
        initData = abi.encode(withdrawTo, minAmount, toBentoBox, taskData);
    }
}
