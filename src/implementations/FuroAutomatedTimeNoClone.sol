...
import "./../base/BaseFuroAutomatedNoClone.sol";
import {FuroStream} from "./../furo/FuroStream.sol";
import {FuroVesting} from "./../furo/FuroVesting.sol";

contract FuroAutomatedTimeNoClone is BaseFuroAutomatedNoClone {
    /// -----------------------------------------------------------------------
    /// Errors
    /// -----------------------------------------------------------------------
    ...
    ) BaseFuroAutomatedNoClone(_bentoBox, _ops, _furo, _owner, _vesting, _id) {
